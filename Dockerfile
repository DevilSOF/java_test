...
RUN echo "#!bin/bash" > commands.sh
RUN echo "java -cp .:hamcrest-core-1.3.jar:junit-4.12.jar:commons-io-2.6.jar org.junit.runner.JUnitCore TestData" >> commands.sh
RUN echo "echo" >> commands.sh
RUN echo "echo Calculations start" >> commands.sh
RUN echo "java Calculations" >> commands.sh
RUN echo "echo" >> commands.sh
RUN echo "echo Calculations end" >> commands.sh
RUN echo "tail -f /dev/null" >> commands.sh
